		...
		switch(opcion1){
			...
			case 2:{
				while(!menu2){
					...
					cout << "7) Consultar Chapinero" << endl;
					cout << "8) Consultar Paseador por localidad Chapinero" << endl;
					cout << "9) Consultar cliente por localidad Chapinero" << endl;
					cout << "10) Consultar sucursal por area" << endl;
					cout << "11) Lista de clientes con mas de un perro" << endl;
					cout << "12) Lista de perros que pertenecen a Chapinero" << endl;
					cout << "13) Lista de perros que cumplen años en junio" << endl;
					cout << "14) Volver" << endl;
					cin >> opcion2;
					switch(opcion2){
						case 1:{
						...
						case 7:{
							...
							tam_sucursales = lista_sucursales.get_tam();
							for(int i = 1; i <= tam_sucursales; i++){
								if(lista_sucursales.buscar(i).localidad==localidad_buscar){
									cout <<"La sucursal que puede hacerse cargo es: " <<lista_sucursales.buscar(i).nombre_sucursal << " " << endl;
								}
							}
							cout << endl;
							...
							string localidad_buscar,sucursal_buscar;
							localidad_buscar="Chapinero";
							sucursal_buscar="ElNogal";
							tam_paseadores = lista_paseadores.get_tam();
							for(int i = 1; i <= tam_paseadores; i++){
								if(lista_paseadores.buscar(i).sucursal==sucursal_buscar){
									cout <<"Los paseadores de la Sucursal son: " <<lista_paseadores.buscar(i).nombre<< " " << lista_paseadores.buscar(i).apellido<<endl;
								}
								if(lista_paseadores.buscar(i).localidad==localidad_buscar && lista_paseadores.buscar(i).sucursal!=sucursal_buscar ){
									cout <<"Los paseadores de la localidad son: " <<lista_paseadores.buscar(i).nombre<< " " << lista_paseadores.buscar(i).apellido<<endl;
								}
							}
							cout << endl;
							system("pause");
						...
						case 9:{
							...
							for(int i = 1; i <= tam_clientes; i++){
								if(lista_clientes.buscar(i).localidad_residencia==localidad_buscar){
									cout <<"Los clientes son: " <<lista_clientes.buscar(i).nombre<< " " << lista_clientes.buscar(i).apellido<<endl;
								}
							}
							cout << endl;
							system("pause");
						...
						case 10:{
							int calleinicio_buscar,callefin_buscar, crafin_buscar,crainicio_buscar;
							calleinicio_buscar=26;
							callefin_buscar=170;
							crainicio_buscar=3;
							crafin_buscar=50;
							tam_sucursales = lista_sucursales.get_tam();
							for(int i = 1; i <= tam_sucursales; i++){
								if(lista_sucursales.buscar(i).calle_fin >= callefin_buscar && lista_sucursales.buscar(i).calle_inicio <= calleinicio_buscar
									&& lista_sucursales.buscar(i).carrera_fin >= crafin_buscar && lista_sucursales.buscar(i).carrera_inicio <= crainicio_buscar){
									cout <<"La sucursal que puede hacerse cargo es: " <<lista_sucursales.buscar(i).nombre_sucursal << " " << endl;
								}
							}
							cout << endl;
						...
						case 11:{
							tam_clientes = lista_clientes.get_tam();
							cout << "Clientes con mas de un perro" << endl;
							for(int i = 1; i <= tam_clientes; i++){
								if(lista_clientes.buscar(i).num_perros > 1){
									cout << "Cliente: " << lista_clientes.buscar(i).nombre << endl;
								}
							}
							system("pause");
							system("cls");
						...
						case 12:{
							tam_clientes = lista_clientes.get_tam();
							cout << "Perros ubicados en Chapinero" << endl;
							for(int i = 1; i <= tam_clientes; i++){
								tam_perros = lista_clientes.buscar(i).num_perros;
								if(lista_clientes.buscar(i).localidad_residencia == "Chapinero"){
									for(int j = 1; j <= tam_perros; j++){
										cout << lista_clientes.buscar(i).lista_perros.buscar(j).nombre << endl;
									}
								}
							}
							system("pause");
						...
						case 13:{
							tam_clientes = lista_clientes.get_tam();
							cout << "Perros que cumplen en Junio" << endl;
							for(int i = 1; i <= tam_clientes; i++){
								tam_perros = lista_clientes.buscar(i).num_perros;
								for(int j = 1; j <= tam_perros; j++){
									if(lista_clientes.buscar(i).lista_perros.buscar(j).mes_nacimiento == 6)
										cout << lista_clientes.buscar(i).lista_perros.buscar(j).nombre << endl;
								}
							}
							system("pause");
